...
exports.agentRunCreateDescription = void 0;
const showOnlyForAgentRunCreate = {
    operation: ["create"],
    resource: ["agentRun"],
};
exports.agentRunCreateDescription = [
    {
        ...
        options: [
            {
                ...
                type: "string",
                default: "",
                description: "Git branch to target (defaults to repository default branch)",
                routing: {
                    send: {
                        type: "body",
                        property: "branch",
            ...
            },
            {
                ...
                type: "boolean",
                default: true,
                description: "Whether to automatically create a pull request with changes",
                routing: {
                    send: {
                        type: "body",
            ...
            },
            {
                ...
                description: "URL to receive webhook notifications when the agent run completes",
                routing: {
                    send: {
                        type: "body",
